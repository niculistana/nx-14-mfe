...
@Component({
  ...
  template: `
      ...
      <div class="grid grid-cols-2 px-2 bg-gray-100">
        ...
        <div class="grid">
          <div
            class="grid grid-cols-3 justify-self-end self-end gap-4 h-12"
          >
            <input
            ...
            />
            <span>
              <button class="h-full bg-gray-200 w-48 rounded-sm border-solid border-1 border-gray-500 border-opacity-70">Log In</button>
            </span>
          </div>
          <div class="justify-self-end self-center px-2 mt-2 w-60">
            <p class="text-xs">
              Don't have an account?
              <a class="text-blue-500" href="http://google.com/">
                Sign up
              </a>
            </p>
          </div>
